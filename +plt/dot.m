function dot(x,y,varargin)
%% Description
%   Make a stylized dot plot for data x against y
%   This is a wrapper function for the dotplot in the dataframe toolbox
...
%   - make plot
plt.helper.dataframe.dotplot(x,y,opts{:},'CAT',CAT);
