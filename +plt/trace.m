function trace(x,y,varargin)
%% Description
%   Make a stylized trace plot for data x against y
%   (Requires that size(x,2) must be the same as size(y,2))
%   This is a wrapper function for the traceplot in the dataframe toolbox
%   varargin can be used to alter properties of the plot
% Input
%   varargin: Format options. 
%       In general: 'formating_option', value,
%       Use help traceplot to get plotting options for parent function in
%       dataframe toolbox
